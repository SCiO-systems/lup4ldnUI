...
export const ClimateProspectsPrecipitationGraph = (props) => {
    ...
    const climateProspectsChart = () => {
        ...
        if(props.data != undefined){
            DATA_URL = props.data.precipitation;
        ...
        var chart = am4core.create("precipitation", am4charts.XYChart);
        ...
        chart.dataSource.adapter.add("parsedData", function(data) {
            ...
            if (rcp4MIN<curMIN) {
                if (rcp8MIN<curMIN) {
                    if (rcp4MIN<rcp8MIN) {
                        document.getElementById("lang_clim_prec_rcp45_min_msg").innerHTML= "<div style='color: red;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
                        document.getElementById("lang_clim_prec_rcp85_min_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
                    }
                    else {
                        document.getElementById("lang_clim_prec_rcp45_min_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
                        document.getElementById("lang_clim_prec_rcp85_min_msg").innerHTML= "<div style='color: red;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
                    }
                }
                else {
                    document.getElementById("lang_clim_prec_rcp45_min_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
            ...
            if (rcp4MAX>curMAX) {
                if (rcp8MAX>curMAX) {
                    if (rcp4MAX>rcp8MAX) {
                        document.getElementById("lang_clim_prec_rcp45_max_msg").innerHTML= "<div style='color: red;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
                        document.getElementById("lang_clim_prec_rcp85_max_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
                    }
                    else {
                        document.getElementById("lang_clim_prec_rcp45_max_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
                        document.getElementById("lang_clim_prec_rcp85_max_msg").innerHTML= "<div style='color: red;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
                    }
                }
                else {
                    document.getElementById("lang_clim_prec_rcp45_max_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
        ...
        <div className="p-grid">
            <div className="range-legend">
                <h2 className="range-legend-title">
                    <span id="lang_clim_prec">Rainfall</span>
                </h2>

                <div className="panel">
                    <div className="panel-title-container">
                        <span id="lang_clim_prec_var1">Historical Average</span>
                        <div className="second-panel-title">
                            <span id="lang_clim_prec_per1" ></span>
                        </div>
                    </div>
                    <div className="second-panel-subtitle">
                        <span id="lang_clim_prec_val1"></span>
                    </div>
                </div>
                ...
                <div className="panel">
                    <div className="panel-title-container">
                        <span id="lang_clim_prec_var2">Average Prospect</span>
                    </div>
                    <div className="second-panel-title">
                        <span id="lang_clim_prec_var2_by1">by 2050</span>
                    </div>
                    <div className="second-panel-subtitle">
                        <span id="lang_clim_prec_val2"></span>
                    </div>
                    <div className="second-panel-title">
                        <span id="lang_clim_prec_var2_by2">by 2100</span>
                    </div>
                    <div className="second-panel-subtitle">
                        <span id="lang_clim_prec_val3"></span>
                    </div>
                </div>

                <div id="prec_rcp45" className="panel">
                    <div className="panel-title-container">
                        <div className="first-panel-title">
                            <span id="lang_clim_prec_rcp45">Best-case global scenario</span>
                        </div>
                        <span id="lang_prec_rcp45name">RCP 4.5</span>
                    </div>
                    <div className="third-panel-subtitle">
                        <span id="lang_clim_prec_rcp45_min"></span>
                    </div>
                    <span id="lang_clim_prec_rcp45_min_msg" ></span>
                    <div className="third-panel-subtitle">
                        <span id="lang_clim_prec_rcp45_max"></span>
                    </div>
                    <span id="lang_clim_prec_rcp45_max_msg" ></span>
                </div>

                <div id="prec_rcp85" className="panel">
                    <div className="panel-title-container">
                        <div className="fourth-panel-subtitle">
                            <span id="lang_clim_prec_rcp85">Worst-case global scenario</span>
                        </div>
                        <span id="lang_prec_rcp85name">RCP 8.5</span>
                    </div>
                    <div className="third-panel-subtitle">
                        <span id="lang_clim_prec_rcp85_min"></span>
                    </div>
                    <span id="lang_clim_prec_rcp85_min_msg" ></span>
                    <div className="third-panel-subtitle">
                        <span id="lang_clim_prec_rcp85_max"></span>
                    </div>
                    <span id="lang_clim_prec_rcp85_max_msg" ></span>
                </div>
            </div>


            <div id="precipitation" className="p-col">
                {climateProspectsChart()}
            </div>
        </div>
