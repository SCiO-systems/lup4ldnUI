...
export const DataUploadSelectionSDG = (props) => {
        ...
        <div>
            <div className="p-col-12">
                ...
                <div className="p-field-radiobutton">
                    ...
                    <label htmlFor="city2">Compute using sub-indicators</label>
                </div>
                <div className="p-field-radiobutton">
                    <RadioButton
                        inputId="city3"
                        ...
                        value="ld"
                        onChange={(e) => enableUserUploadData(e)}
                        checked={customData === 'ld'} />
                    <label htmlFor="city3">Use custom Land Degradation map</label>
                </div>
            </div>
