...
export const ClimateProspectsSpectralIndices2Graph = (props) => {

    const [displaySMIDialog, setDisplaySMIDialog] = useState(false);
    ...
    const climateProspectsChart = () => {
        ...
        var chart = am4core.create("spectralindices2", am4charts.XYChart);
        ...
        chart.dataSource.adapter.add("parsedData", function(data) {
            ...
            document.getElementById("lang_idx_smi_per1").innerHTML= clim_prec_per1;
            ...
            document.getElementById("lang_idx_smi_val1").innerHTML= clim_prec_val1;
            //-------
            ...
            //-------
            document.getElementById("lang_idx_smi_val2").innerHTML= clim_prec_val2;
            //-------
            ...
            //-------
            document.getElementById("lang_idx_smi_val3").innerHTML= clim_prec_val3;
            //-------
            document.getElementById("lang_idx_smi_rcp45_min").innerHTML= "MIN = "+rcp4MIN.toFixed(2);
            document.getElementById("lang_idx_smi_rcp45_max").innerHTML= "MAX = "+rcp4MAX.toFixed(2);
            //-------
            document.getElementById("lang_idx_smi_rcp85_min").innerHTML= "MIN = "+rcp8MIN.toFixed(2);
            document.getElementById("lang_idx_smi_rcp85_max").innerHTML= "MAX = "+rcp8MAX.toFixed(2);
            //-------
            document.getElementById("lang_idx_smi_rcp45_min_msg").innerHTML="";
            document.getElementById("lang_idx_smi_rcp85_min_msg").innerHTML="";
            document.getElementById("lang_idx_smi_rcp45_max_msg").innerHTML="";
            document.getElementById("lang_idx_smi_rcp85_max_msg").innerHTML="";
            //-------
            if (rcp4MIN<curMIN) {
                if (rcp8MIN<curMIN) {
                    if (rcp4MIN<rcp8MIN) {
                        document.getElementById("lang_idx_smi_rcp45_min_msg").innerHTML= "<div style='color: red;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
                        document.getElementById("lang_idx_smi_rcp85_min_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
                    }
                    else {
                        document.getElementById("lang_idx_smi_rcp45_min_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
                        document.getElementById("lang_idx_smi_rcp85_min_msg").innerHTML= "<div style='color: red;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
                    }
                }
                else {
                    document.getElementById("lang_idx_smi_rcp45_min_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical minimum</span></div>";
            ...
            if (rcp4MAX>curMAX) {
                if (rcp8MAX>curMAX) {
                    if (rcp4MAX>rcp8MAX) {
                        document.getElementById("lang_idx_smi_rcp45_max_msg").innerHTML= "<div style='color: red;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
                        document.getElementById("lang_idx_smi_rcp85_max_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
                    }
                    else {
                        document.getElementById("lang_idx_smi_rcp45_max_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
                        document.getElementById("lang_idx_smi_rcp85_max_msg").innerHTML= "<div style='color: red;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
                    }
                }
                else {
                    document.getElementById("lang_idx_smi_rcp45_max_msg").innerHTML= "<div style='color: orange;'><i class='far fa-exclamation-triangle' aria-hidden='true'></i> <span>Historical maximum</span></div>";
    ...
    const basicDialogFooter = <Button type="button" label="OK" onClick={() => setDisplaySMIDialog(false)} icon="pi pi-check" className="p-button-text" />;

    const toggleInfo = () =>{
        setDisplaySMIDialog(true);
    }
        ...
        <div className="p-grid">
            <div className="range-legend">
                <h4 className="range-legend-title">
                    <span id="lang_clim_prec">Soil Moisture Index (SMI) </span>
                    <i
                ...
                <div className="panel">
                    <div className="panel-title-container">
                        <span id="lang_idx_smi_var1">Historical Average</span>
                        <div className="second-panel-title">
                            <span id="lang_idx_smi_per1" ></span>
                        </div>
                    </div>
                    <div className="second-panel-subtitle">
                        <span id="lang_idx_smi_val1"></span>
                    </div>
                </div>
                ...
                <div className="panel">
                    <div className="panel-title-container">
                        <span id="lang_idx_smi_var2">Average Prospect</span>
                    </div>
                    <div className="second-panel-title">
                        <span id="lang_idx_smi_var2_by1">by 2050</span>
                    </div>
                    <div className="second-panel-subtitle">
                        <span id="lang_idx_smi_val2"></span>
                    </div>
                    <div className="second-panel-title">
                        <span id="lang_idx_smi_var2_by2">by 2100</span>
                    </div>
                    <div className="second-panel-subtitle">
                        <span id="lang_idx_smi_val3"></span>
                    </div>
                </div>

                <div id="smi_rcp45" className="panel">
                    <div className="panel-title-container">
                        <div className="first-panel-title">
                            <span id="lang_idx_smi_rcp45">Best-case global scenario</span>
                        </div>
                        <span id="lang_prec_rcp45name">RCP 4.5</span>
                    </div>
                    <div className="third-panel-subtitle">
                        <span id="lang_idx_smi_rcp45_min"></span>
                    </div>
                    <span id="lang_idx_smi_rcp45_min_msg" ></span>
                    <div className="third-panel-subtitle">
                        <span id="lang_idx_smi_rcp45_max"></span>
                    </div>
                    <span id="lang_idx_smi_rcp45_max_msg" ></span>
                </div>

                <div id="smi_rcp85" className="panel">
                    <div className="panel-title-container">
                        <div className="fourth-panel-subtitle">
                            <span id="lang_idx_smi_rcp85">Worst-case global scenario</span>
                        </div>
                        <span id="lang_prec_rcp85name">RCP 8.5</span>
                    </div>
                    <div className="third-panel-subtitle">
                        <span id="lang_idx_smi_rcp85_min"></span>
                    </div>
                    <span id="lang_idx_smi_rcp85_min_msg" ></span>
                    <div className="third-panel-subtitle">
                        <span id="lang_idx_smi_rcp85_max"></span>
                    </div>
                    <span id="lang_idx_smi_rcp85_max_msg" ></span>
                </div>
            </div>


            <div id="spectralindices2" className="p-col">
                {climateProspectsChart()}
            </div>
        </div>
