...
const AppTopbar = (props) => {
    ...
    const [selectedCountry, setSelectedCountry] = useState({name: 'English', code: 'UK'});
                            ...
                            <li role="menuitem">
                                <button type="button" className="p-link">
                                    ...
                                    <div className="notification-item">
                                        <div className="notification-summary">Invitations</div>
                                        <div className="notification-detail">You are invited in <strong>3</strong> projects</div>
                                    </div>
                                </button>
                            </li>
                            <li role="menuitem">
                                <button type="button" className="p-link">
                                    ...
                                    <div className="notification-item">
                                        <div className="notification-summary">Actions</div>
                                        <div className="notification-detail">in <strong>2</strong> Projects</div>
                                    </div>
                                </button>
                            </li>
                            <li role="menuitem">
